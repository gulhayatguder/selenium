...
public class C02_KeyboardActions extends TestBase {
    ...
    public void test01(){
       ...
       String actualsonucSayisi=driver.findElement(By.xpath("//h1[@class=‘a-size-base s-desktop-toolbar a-text-normal’]")).getText();
       String expectedIcerik="Samsung A71";
        Assert.assertTrue(actualsonucSayisi.contains(expectedIcerik));
