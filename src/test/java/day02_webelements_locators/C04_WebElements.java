...
public class C04_WebElements {
    public static void main(String[] args) throws InterruptedException {
     ...
     8 TANE LOCATER VARDIR
       ...
       1- driver.findElement(By.className());
       2-  driver.findElement(By.id());
       3- driver.findElement(By.name());
       4- driver.findElement(By.linkText());
       5-driver.findElement(By.partialLinkText());
       6- driver.findElement(By.tagName());
   Bu iki element her türlü webelementi locate etmek icin kullanilabilir
